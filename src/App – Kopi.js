...
class App extends Component {
  ...
  initMap() {
    ...
    // geocoder.geocode(requestGeocode, function(results, status) {
    //   if (status === 'OK') {
    ...
    //
    //     service.nearbySearch(requestNearestBar, function(results, status){
    ...
    // service.nearbySearch(requestNearestBar, this.callback);
  }
